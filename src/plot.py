...
def plot_monty_hall(switch: bool, num_simulations: int, fileformat: str):
    ...
    if switch:
        ...
        plt.plot(num_tests, win_percentage, label='závislost pravděpodobnosti výhry na počtu simulací hry')
        ...
        plt.figure(figsize=(12.2, 7.5), dpi=100)
        plt.plot(num_tests, win_percentage, label=f'funkce pravděpodobnosti výhry \nv závislosti na počtu simulací hry')
